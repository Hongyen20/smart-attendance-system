...
/// Shared color palette for all UI

class AppColors {
  static const Color primaryBlue = Color(0xFF1E3A8A);
  static const Color accentBlue = Color(0xFF2563EB);
  static const Color background = Color.fromARGB(255, 236, 239, 255);
  static const Color cardBackground = Colors.white;
  static const Color infoBoxBackground = Color(0xFFEEF0FC);
  static const Color textPrimary = Color(0xFF1F2430);
  static const Color textSecondary = Color(0xFF6B7280);
  static const Color borderColor = Color(0xFFE2E4EC);
